...
export default function PublicBooking() {
  ...
  // Marketing content with defaults
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-primary/3">
      ...
      <FeatureCards
        ...
        feature1Description="We will contact you soon"
        feature2Title="Personal Call"
        feature2Description="Staff will confirm details"
        feature3Title="Flexible Booking"
        feature3Description="Choose your preferred time"
        extraFeatures={marketing.features}
      />
      ...
      <TrustBadges
        message1="Premium Care"
        message2="Expert Specialists"
        message3="Modern Technology"
      />
