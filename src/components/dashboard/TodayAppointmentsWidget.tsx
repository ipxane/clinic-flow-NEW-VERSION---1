      ...
      {showActions ? (
        <div className="flex flex-col gap-1.5 shrink-0">
          <Button
            size="sm"
            variant="outline"
            className="h-8 text-xs gap-1 text-green-600 border-green-200 hover:bg-green-50 hover:text-green-700 dark:text-green-400 dark:border-green-800 dark:hover:bg-green-950"
          ...
          <Button
            size="sm"
            variant="outline"
            className="h-8 text-xs gap-1 text-orange-600 border-orange-200 hover:bg-orange-50 hover:text-orange-700 dark:text-orange-400 dark:border-orange-800 dark:hover:bg-orange-950"
            disabled={updatingId === appointment.id}
        ...
        <Badge
          ...
          className={
            appointment.status === "completed"
              ? "status-badge bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
              : "status-badge bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-300"
          }
        >
