                        ...
                        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
                            {clinicProfile?.phone_number && (
                                <a
                                    ...
                                    className="group flex items-center gap-2.5 text-foreground/70 hover:text-primary transition-all duration-200 bg-card/80 backdrop-blur-sm px-5 py-3 rounded-full border border-border/60 hover:border-primary/40 hover:shadow-md"
                                >
                                    <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                                        <Phone className="w-4 h-4 text-primary" />
                                    </div>
                                    <span className="font-medium">{clinicProfile.phone_number}</span>
                                </a>
                            )}
                            {clinicProfile?.email && (
                                <a
                                ...
                                >
                                    ...
                                    <span className="font-medium">{clinicProfile.email}</span>
                                </a>
                            )}
                            {clinicProfile?.address && (
                                <div className="flex items-center gap-2.5 text-foreground/70 bg-card/80 backdrop-blur-sm px-5 py-3 rounded-full border border-border/60">
                                    <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                                        <MapPin className="w-4 h-4 text-primary" />
                                    </div>
                                    <span className="font-medium">{clinicProfile.address}</span>
                                </div>
                            )}
                        </div>
                    )}
